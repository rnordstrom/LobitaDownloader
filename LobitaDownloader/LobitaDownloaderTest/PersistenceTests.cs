...
namespace LobitaDownloaderTest
{
    ...
    public class PersistenceTests
    {
        ...
        public void TestImagePersist()
        {
            ...
            ImageData imgData = new ImageData(fileExt, image);
        ...
        public void TestVideoPersist()
        {
            ...
            foreach (string handle in Constants.VideoCmdHandles)
            {
                fvm.Persist(handle, videoList);
            }

            DirectoryInfo[] directories = fvm.DataDirectory.GetDirectories();
            Assert.AreEqual(Constants.VideoCmdHandles.Length, directories.Length);
